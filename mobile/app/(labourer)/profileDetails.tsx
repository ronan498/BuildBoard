...
export default function LabourerProfileDetails() {
  ...
  // Hydrate local edit fields when profile loads/changes
  useEffect(() => {
    if (profile) {
  ...
  const save = () => {
    if (!user) return;
    // Trim; allow undefined so blank fields hide when not editing
  ...
  // Which fields to show when not editing
          ...
          >
            ...
            <View style={styles.avatarWrap}>
              <Pressable onPress={() => editing && pickImage("avatarUri")} disabled={!editing}>
                <Image
                  source={{ uri: profile.avatarUri ?? "https://i.pravatar.cc/150?img=59" }}
                  style={styles.avatar}
                />
              </Pressable>
            </View>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.metaGrid}>
                ...
                <Meta icon="person-outline" label="Role" value={profile.role[0].toUpperCase() + profile.role.slice(1)} />
              </View>
              ...
              <View style={styles.card}>
                ...
                {profile.qualifications.map((q) => (
                  <View key={q.id} style={styles.qualRow}>
                    {/* Clickable grey box; shows "+" placeholder if no image */}
                    <Pressable
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={[styles.badge, q.status === "verified" ? styles.badgeVerified : styles.badgePending]}>
